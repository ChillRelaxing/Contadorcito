$(document).ready(function() {
    ...
    function getData() {
        ...
        if ($.fn.DataTable.isDataTable('#purchaseReceiptsTable')) {
            $('#purchaseReceiptsTable').DataTable().destroy();
        }
    ...
    updateModal.addEventListener("shown.bs.modal", (event) => {
        ...
        let inputPurchaseDate = updateModal.querySelector(".modal-body #purchase_date");
        ...
        let inputSupplierId = updateModal.querySelector(".modal-body #supplier_id");
