...
<head>
    ...
    <title>Recepciones de Ventas</title>
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <div class="d-flex align-items-center justify-content-between">
                                        <h4 class="card-title">Listado de Recibos de Ventas</h4>
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table id="salesReceiptsTable" class="display table table-striped table-hover">
                                            <thead>
                                                <tr>
                                                    <th>Id</th>
        ...
        <script>
            $(document).ready(function() {
                ...
                updateModal.addEventListener("shown.bs.modal", (event) => {
                    ...
                    .then(response => response.json())
                    .then(data => {
                        updateModal.querySelector(".modal-body #id").value = data.id;
                        updateModal.querySelector(".modal-body #receiptType").value = data.receiptType;
                        updateModal.querySelector(".modal-body #sale_date").value = data.sale_date;
                        updateModal.querySelector(".modal-body #total").value = data.total;
                        updateModal.querySelector(".modal-body #pdf_path").value = data.pdf_path;
                        updateModal.querySelector(".modal-body #json_path").value = data.json_path;
                        updateModal.querySelector(".modal-body #client_id").value = data.client_id;
                        updateModal.querySelector(".modal-body #user_id").value = data.user_id;
                        updateModal.querySelector(".modal-body #company_id").value = data.company_id;
                    });
                });
            });
        </script>
